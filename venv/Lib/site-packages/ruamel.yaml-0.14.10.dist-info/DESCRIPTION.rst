...
0.14.8 (2017-04-19):
  - fix Text not available on 3.5.0 and 3.5.1, now proactively setting version guards
    on all files (reported by `JoГЈo Paulo MagalhГЈes <https://bitbucket.org/jpmag/>`_)
...
0.14.2 (2017-03-23):
  - fix for old default pip on Ubuntu 14.04 (reported by SГ©bastien Maccagnoni-Munch)

0.14.1 (2017-03-22):
  - fix Text not available on 3.5.0 and 3.5.1 (reported by Charles Bouchard-LГ©garГ©)
